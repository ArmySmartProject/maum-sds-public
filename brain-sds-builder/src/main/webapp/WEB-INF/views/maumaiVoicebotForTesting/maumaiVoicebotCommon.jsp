...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/css/maumaiVoicebot.css?v=${queryString}">
  ...
  <script src="${pageContext.request.contextPath}/js/maumaiVoicebotForTesting/maumaiVoicebotCommon.js?v=${queryString}"></script>
...
<div id="vb_wrap" class="loading">
  ...
  <div class="test_on" id="vb_container"  class="">
    <%-- container_box --%>
    <div class="container_box">
      <%-- vb_header --%>
      <div id="vb_header">
        <div>
          <span class="title">시나리오 명 : </span>
          <span class="title_scenario">음성봇 테스트</span>
        </div>
    ...
    <div class="vb_test data_debug scroll ">
      ...
      <div class="resize_areas">
        <div class="resize_area" style="display: none">
          <!-- vb_tab -->
          <div class="vb_tab">
        ...
        <div class="drag_resize" style="display: none"><img src="../images/ico_grabmark.svg" alt="드래그 할 수 있다는 표시"></div>

        <div class="resize_area">
          <!-- vb_tab -->
          <div class="vb_tab mt3">
            <!-- vb_tab_menu 음성봇 -->
            <div class="vb_tab_menu">
              <button type="button" style="display:none;">챗봇</button>
              <button type="button">음성봇</button>
            </div>
            <!-- //vb_tab_menu -->
            <!-- vb_tab_cont 챗봇 -->
            <div class="vb_tab_cont" style="display:none; position: relative;">
